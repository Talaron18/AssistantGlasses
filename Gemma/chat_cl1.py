...
1. When a tool is needed, emit ONLY the function call — zero surrounding text.
   Do NOT narrate intent before calling (e.g. "I'll take a photo", "Let me start
   navigation"). Just call the function silently.
2. Each tool's description states its exact trigger conditions. Follow them strictly;
   never call a tool for hypothetical, metaphorical, or unrelated references.
3. After tool results are returned, respond naturally in the conversation language.
...
class Gemma4Agent(BaseAgent):
    ...
    def __init__(
        ...
        if nav_controller is not None:
            ...
            print("[Gemma4Agent] Navigation tools registered.")
        ...
        self.tools.extend([
            {
                ...
                "function": {
                    ...
                    "description": (
                        ...
                        "Call ONLY when the user explicitly says they want to go "
                        "somewhere, navigate to a place, or asks for directions. "
                        "Do NOT call for casual mentions of locations."
                    ),
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "destination": {
                                "type": "string",
                                "description": (
                                    "Name or address of the destination, "
                                    "e.g. '王府井大街' or '最近的便利店'."
                                ),
                            }
                        },
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": (
                        "Stop / cancel the current navigation. "
                        "Call when the user says to stop, cancel, or end navigation."
                    ),
                    "parameters": {
                        "type": "object",
                        "properties": {},
            ...
            },
            {
                ...
                "function": {
                    "name": "get_nav_status",
                    "description": (
                        "Query the live navigation status: current state "
                        "(IDLE / PLANNING / NAVIGATING), destination, active step, "
                        "and GPS fix. Use when the user asks 'where am I', "
                        "'what step am I on', 'are we navigating', etc."
                    ),
                    "parameters": {
                        "type": "object",
                        "properties": {},
